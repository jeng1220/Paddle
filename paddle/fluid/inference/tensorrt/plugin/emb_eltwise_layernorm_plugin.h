...
template <typename T>
class EmbEltwiseLayernormPluginDynamicImpl : public EmbEltwiseLayernormPluginDynamicImplBase {
public:
...
class EmbEltwiseLayernormPluginDynamic : public DynamicPluginTensorRT {
 public:
  ...
  void destroy() override { delete impl_; delete this; }
...
class EmbEltwiseLayernormPluginV2Creator : public nvinfer1::IPluginCreator {
 public:
  ...
  nvinfer1::IPluginV2* deserializePlugin(const char* name,
    ...
    return new EmbEltwiseLayernormPluginDynamic(serialData,
                                                serialLength);
  }
